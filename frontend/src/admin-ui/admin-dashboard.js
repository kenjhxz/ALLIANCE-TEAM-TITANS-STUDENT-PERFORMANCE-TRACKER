    ...
    return (
      <div className="app">
        ...
        <div
          ...
          style={{ width: sidebarOpen ? 220 : 60, transition: "width 0.2s", overflow: "hidden" }}
        >
          ...
          <div className="sb-section">
            ...
            >
              <svg viewBox="0 0 24 24" fill="none" className="sb-icon" aria-hidden="true"><path d="M3 13h18v8H3z" stroke="#EFE9E1" strokeWidth="1.2"/><path d="M7 6h10v6H7z" stroke="#EFE9E1" strokeWidth="1.2"/></svg>
            ...
            <NavLink
              ...
              className={({isActive}) => `sb-item ${isActive ? 'active' : ''}`}
            >
              <svg viewBox="0 0 14 14" fill="none" className="sb-icon" aria-hidden="true"><circle cx="7" cy="5" r="3" stroke="#EFE9E1" strokeWidth="1.2"/><path d="M2 12c0-2.2 2.2-4 5-4s5 1.8 5 4" stroke="#EFE9E1" strokeWidth="1.2" strokeLinecap="round"/></svg>
            ...
            <NavLink
              ...
              className={({isActive}) => `sb-item ${isActive ? 'active' : ''}`}
            >
              <svg viewBox="0 0 14 14" fill="none" className="sb-icon" aria-hidden="true"><circle cx="5" cy="5" r="2.5" stroke="#EFE9E1" strokeWidth="1.2"/><circle cx="10" cy="8" r="2" stroke="#EFE9E1" strokeWidth="1.2"/><path d="M1 12c0-1.7 1.8-3 4-3" stroke="#EFE9E1" strokeWidth="1.1" strokeLinecap="round"/></svg>
            ...
            <NavLink
              ...
              className={({isActive}) => `sb-item ${isActive ? 'active' : ''}`}
            >
              <svg viewBox="0 0 14 14" fill="none" className="sb-icon" aria-hidden="true"><path d="M7 1L13 4v3c0 3.3-2.5 6-6 7C1 13 1 7 1 7V4l6-3z" stroke="#EFE9E1" strokeWidth="1.2"/></svg>
            ...
            <NavLink
              ...
              className={({isActive}) => `sb-item ${isActive ? 'active' : ''}`}
            >
              <svg viewBox="0 0 14 14" fill="none" className="sb-icon" aria-hidden="true"><rect x="1" y="2" width="12" height="10" rx="1.5" stroke="#EFE9E1" strokeWidth="1.2"/><path d="M4 6h6M4 9h4" stroke="#EFE9E1" strokeWidth="1.1" strokeLinecap="round"/></svg>
            ...
            <NavLink
              ...
              className={({isActive}) => `sb-item ${isActive ? 'active' : ''}`}
            >
              <svg viewBox="0 0 14 14" fill="none" className="sb-icon" aria-hidden="true"><rect x="1" y="3" width="12" height="9" rx="1" stroke="#EFE9E1" strokeWidth="1.2"/><path d="M4 1v3M10 1v3M1 6h12" stroke="#EFE9E1" strokeWidth="1.1" strokeLinecap="round"/></svg>
          ...
          <div className="sb-section">
            ...
            <NavLink
              to="/admin-dashboard/flags"
              className={({isActive}) => `sb-item ${isActive ? 'active' : ''}`}
            >
              <svg viewBox="0 0 24 24" fill="none" className="sb-icon" aria-hidden="true"><path d="M6 3v18" stroke="#EFE9E1" strokeWidth="1.4" strokeLinecap="round"/><path d="M6 6h12l-3 4 3 4H6" stroke="#EFE9E1" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/></svg>
            ...
            <NavLink
              ...
              className={({isActive}) => `sb-item ${isActive ? 'active' : ''}`}
            >
              <svg viewBox="0 0 24 24" fill="none" className="sb-icon" aria-hidden="true"><path d="M12 2v6" stroke="#EFE9E1" strokeWidth="1.4" strokeLinecap="round"/><path d="M6 10h12" stroke="#EFE9E1" strokeWidth="1.4" strokeLinecap="round"/><path d="M4 20h16" stroke="#EFE9E1" strokeWidth="1.4" strokeLinecap="round"/></svg>
